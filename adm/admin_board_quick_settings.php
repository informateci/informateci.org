...
*
* @package Icy Phoenix
* @version $Id: admin_board_quick_settings.php 76 2009-01-31 21:11:24Z Mighty Gorgon $
...
if (substr($mode, 0, 3) == 'set')
{
	...
	if ($mode == 'set_all')
	{
		...
		*/
		...
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '1' WHERE `config_name` = 'index_links'";
		...
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '1' WHERE `config_name` = 'enable_digests'";
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '1' WHERE `config_name` = 'digests_php_cron'";
		...
		$sql[] = "UPDATE `" . $table_prefix . "xs_news_cfg` SET `config_value` = '1' WHERE `config_name` = 'xs_show_news'";
		$sql[] = "UPDATE `" . $table_prefix . "xs_news_cfg` SET `config_value` = '1' WHERE `config_name` = 'xs_show_ticker'";
	}
	...
	if ( $mode == 'set_fnf' )
	{
		...
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '1' WHERE `config_name` = 'disable_registration_ip_check'";
		...
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '0' WHERE `config_name` = 'index_links'";
		...
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '0' WHERE `config_name` = 'enable_digests'";
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '0' WHERE `config_name` = 'digests_php_cron'";
		...
		$sql[] = "UPDATE `" . $table_prefix . "xs_news_cfg` SET `config_value` = '0' WHERE `config_name` = 'xs_show_news'";
		$sql[] = "UPDATE `" . $table_prefix . "xs_news_cfg` SET `config_value` = '0' WHERE `config_name` = 'xs_show_ticker'";
	}
	...
	if ( $mode == 'set_mg_fav' )
	{
		...
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '1' WHERE `config_name` = 'enable_new_messages_number'";
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '0' WHERE `config_name` = 'google_bot_detector'";
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '1' WHERE `config_name` = 'inactive_users_memberlists'";
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '0' WHERE `config_name` = 'xmas_fx'";
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '1' WHERE `config_name` = 'extra_display'";
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '0' WHERE `config_name` = 'disable_topic_view'";
		$sql[] = "UPDATE `" . $table_prefix . "config` SET `config_value` = '0' WHERE `config_name` = 'disable_referrers'";
