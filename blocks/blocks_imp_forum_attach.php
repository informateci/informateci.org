...
*
* @package Icy Phoenix
* @version $Id: blocks_imp_forum_attach.php 76 2009-01-31 21:11:24Z Mighty Gorgon $
...
if(!function_exists('imp_forum_attach_block_func'))
{
	function imp_forum_attach_block_func()
	{
		...
		if ($cms_config_vars['md_single_post_retrieve'][$block_id] == true)
		{
			if ($cms_config_vars['md_single_post_auto_id'][$block_id] == true)
			{
