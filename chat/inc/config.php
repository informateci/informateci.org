<?php
	...
	$GLOBALS['fc_config'] = array(
		...
		//Cach config
		'cacheType' => 0, // 0 = no caching, 1 = limited caching, 2 = full caching
		'cachePath' => INC_DIR . '../templates/cache/', // cache folder in: ./../chat/
		'cacheFilePrefix' => '0435456897', // prefix of cache file
		...
		'version'         => '4.8.2', //architecture release . feature release . patch release
		...
		'showConfirmation'=> false, //set to true to allow confirmation popup window for admin (moderator)
		...
		'userListAutoExpand' => true,   //if true user list opens all the rooms with users in them
		...
		'autoremoveAfter' => 10,    //number of seconds before room is removed
		...
		//your CMS system
		'CMSsystem' => 'phpBB2CMS',// defaultCMS - default CMS, blank - stateless CMS
		...
		'msgRemoveAfter'  => 2*3600, 	    //messages removed after this time, seconds

		//Connection processing
		'autologoutAfter' => 20,  //time of pooling inactivity after which user is considered logged off, seconds
		...
		'defaultLanguage' => 'it',	//two-letter code of the default language (see below)
		...
		'filesharing' => array(
			'allowShareRoom'   => true,//moderators can always share with all users in a room - this option is only for non-moderators
			'allowShareChat'   => true,//moderators can always share with all users in a chat - this option is only for non-moderators
...
if(!$GLOBALS['fc_config_stop'])
{
	...
	require_once(INC_DIR . 'langs/kr.php');	//Brazilian Portuguese
