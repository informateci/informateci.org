<?php /* Smarty version 2.6.10, created on 2007-11-13 19:18:14
...
<body bgcolor="#FFFFCC" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"
	<?php if ($this->_tpl_vars['data']['lin']): ?> onLoad="setFocus()" onUnload="doLogout()"<?php endif; ?>>
...
<table width="100%" height="100%" border="0" cellpadding="8" cellspacing="0">
  ...
  <tr>
    ...
    <td width="90%" valign=top bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="4">
		...
		<?php if ($this->_tpl_vars['data']['lin']): ?>
			<tr>
				<td class=normal>
			...
			<tr>
				<td class=normal>
			   	<?php echo $this->_tpl_vars['data']['flashChatTag']; ?>
