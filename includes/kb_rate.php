...
*
* @package Icy Phoenix
* @version $Id: kb_rate.php 64 2008-12-01 21:14:17Z Mighty Gorgon $
...
if ($kb_config['votes_check_ip'] == 1)
{
	...
	{
		$redirect_url = append_sid(this_kb_mxurl('action=url&amp;k=' . $article_id));
...
else
{
	...
	$template->assign_vars(array(
		'S_RATE_ACTION' => append_sid(this_kb_mxurl('mode=rate&amp;cat=' . $category_id . '&amp;k=' . $article_id)),
		'L_RATE' => $lang['Rate'],
