...
*
* @package Icy Phoenix
* @version $Id: template.php 61 2008-10-30 09:25:26Z Mighty Gorgon $
...
* derived from an LGPL application may be relicenced under the GPL, this applies to this source
*/

define('PA_TPL_PREFIX', 'tpl_');
...
class pafiledb_Template
{
	...
	var $cache_root = MAIN_CACHE_FOLDER;
	var $files = array();
	...
	function _tpl_load(&$handle)
	{
		...
		$filename = $this->cachedir . PA_TPL_PREFIX . str_replace(IP_ROOT_PATH . 'templates/', '', $this->root) . '.' . $this->filename[$handle] . '.' . (($this->static_lang) ? $userdata['user_lang'] . '.' : '') . PHP_EXT;
