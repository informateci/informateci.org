...
*
* @package Icy Phoenix
* @version $Id: site_hist_daily_stats_current_week_module.php 64 2008-12-01 21:14:17Z Mighty Gorgon $
...
for ($i = 0; $i < 7; $i++)
{
	if ($i == 6)
	{
		$l_currrent_day = '<strong>' . create_date('D', $time_today, $board_config['board_timezone']) . '</strong>';
	}
	else
	{
		$l_currrent_day = create_date('D', $time_today, $board_config['board_timezone']);
	}
