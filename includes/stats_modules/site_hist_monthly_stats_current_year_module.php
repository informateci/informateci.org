...
*
* @package Icy Phoenix
* @version $Id: site_hist_monthly_stats_current_year_module.php 64 2008-12-01 21:14:17Z Mighty Gorgon $
...
$template->assign_vars(array(
	...
	'MONTH_BACK' => sprintf($lang['Most_online'], create_date('Y', $time_thismonth, $board_config['board_timezone'])),
	'L_MONTH' => $lang['Month'],
...
for ($i = 0; $i < 12; $i++)
{
	...
	if ($stat_db->sql_numrows($result))
	{
		...
		{
			$l_month = create_date('F', $month[$i], $board_config['board_timezone']);
		}
	...
	else
	{
		...
		$template->assign_block_vars('stats_row', array(
			'CLASS' => $class,
			'MONTH' => create_date('F', $month[$i], $board_config['board_timezone']),
