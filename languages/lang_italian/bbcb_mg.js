s_formerrors = 'Devi inserire del testo per poter inviare un messaggio';
s_gen_error = ':: Errore ::\n\n';
s_url_insert = 'Inserisci l\'URL (es. http://www.phpbb.com/)';
s_url_insert_tip = 'http://';
s_url_error = 'Non hai inserito alcun indirizzo';
s_url_title_insert = 'Inserisci un titolo per il link';
s_url_title_insert_tip = 'Link';
s_url_title_error = 'Non hai inserito alcun nome per la pagina';
s_email_insert = 'Inserisci un indirizzo email';
s_email_insert_tip = 'yourname@yourdomain.com';
s_email_error = 'Non hai inserito alcun indirizzo';
s_img_insert = 'Inserisci l\'indirizzo dell\'immagine';
s_img_error = 'Non hai inserito l\'indirizzo dell\'immagine';
s_albumimg_insert = 'Inserisci l\'ID dell\'immagine';
s_albumimg_insert_tip = 'ID';
s_albumimg_error = 'Non hai inserito l\'ID dell\'immagine';
s_ram_insert = 'Inserisci l\'indirizzo del file Real Media';
s_stream_insert = 'Inserisci l\'indirizzo del file audio';
s_video_insert = 'Inserisci l\'indirizzo del file video';
s_video_w_insert = 'Inserisci la larghezza del file video';
s_video_w_error = 'Non hai inserito la larghezza del file video';
s_video_h_insert = 'Inserisci l\'altezza del file video';
s_video_h_error = 'Non hai inserito l\'altezza del file video';
s_googlevideo_insert = 'Inserisci l\'ID del file Google Video';
s_youtube_insert = 'Inserisci l\'ID del video YouTube';
s_emff_insert = 'Inserisci l\'indirizzo del file mp3';
s_flash_insert = 'Inserisci l\'indirizzo del file Flash';
s_flash_w_insert = 'Inserisci la larghezza del file Flash';
s_flash_w_error = 'Non hai inserito la larghezza del file Flash';
s_flash_h_insert = 'Inserisci l\'altezza del file Flash';
s_flash_h_error = 'Non hai inserito l\'altezza del file Flash';
s_id_insert_tip = 'ID';
s_id_insert_error = 'Non hai inserito l\'ID';
s_file_insert_error = 'Non hai inserito l\'indirizzo del file';
s_grad_select = 'Seleziona il test';
s_grad_error = 'Selezionare al massimo 120 caratteri';
s_grad_path = "includes/grad.htm";
s_view_more_code = 'Visualizza pi&ugrave codice';
s_image_upload = 'Carica un\'immagine su PostImage.org e l\'aggiunge al messaggio';
s_posticyimage = 'Carica un\'immagine e l\'aggiunge al messaggio';

// Helpline messages
s_a_help = 'Chiudi tutti i tags';
s_b_help = 'Grassetto testo: [b]testo[/b]';
s_i_help = 'Corsivo testo: [i]testo[/i]';
s_l_help = 'Latex: [tex]formula[/tex]';
s_u_help = 'Sottolineatura testo: [u]testo[/u]';
s_strike_help = 'Sbarratura testo: [strike]testo[/strike]';
s_quote_help = 'Citazione testo: [quote]testo[/quote]';
s_code_help = 'Codice: [code]codice[/code]';
s_phpbbmod_help = 'phpBB Mod Template';
s_highlight_help = 'Evidenzia: [highlight=#FFFFAA]testo[/highlight]';
s_img_help = 'Inserisci immagine: [img]http://image_url[/img]';
s_imgl_help = 'Inserisci immagine con allineamento a sx: [img align=left]http://image_url[/img]';
s_imgr_help = 'Inserisci immagine con allineamento a dx: [img align=right]http://image_url[/img]';
s_albumimg_help = 'Inserisci immagine dall\'album: [albumimg]Album Pic ID[/albumimg]';
s_albumimgl_help = 'Inserisci immagine dall\'album con allineamento a sinistra: [albumimg align=left]Album Pic ID[/albumimg]';
s_albumimgr_help = 'Inserisci immagine dall\'album con allineamento a destra: [albumimg align=right]Album Pic ID[/albumimg]';

s_url_help = 'Inserisci URL: [url]http://url[/url] o [url=http://url]URL testo[/url]';
s_fc_help = 'Colore Font: [color=red]testo[/color] (Consiglio: puoi anche usare color=#FF0000)';
s_fs_help = 'Dimensione Font: [size=9]testo[/size]';
s_ft_help = 'Tipo Font: [font=Andalus]testo[/font]';
s_table_help = 'Inserisci tabella: [table]testo[/table]';
s_td_help = 'Inserisci colonna in tabella: [td]testo[/td]';
s_mail_help = 'Inserisci email: [email]indirizzo email[/email]';
s_grad_help = 'Inserisci gradiente testo';
s_right_help = 'Allinea il testo a destra: [align=right]testo[/align]';
s_left_help = 'Allinea il testo a sinistra: [align=left]testo[/align]';
s_center_help = 'Allinea il testo al centro: [align=center]testo[/align]';
s_justify_help = 'Giustifica testo: [align=justify]testo[/align]';
s_marqr_help = 'Scorrimento testo a destra: [marquee direction=right]testo[/marquee]';
s_marql_help = 'Scorrimento testo a sinistra: [marquee direction=left]testo[/marquee]';
s_marqu_help = 'Scorrimento testo in alto: [marquee direction=up]testo[/marquee]';
s_marqd_help = 'Scorrimento testo in basso: [marquee direction=down]testo[/marquee]';
s_sup_help = 'Apice: [sup]testo[/sup]';
s_sub_help = 'Pedice: [sub]testo[/sub]';
s_hr_help = 'Inserisci linea orizzontale [hr]';
s_bullet_help = 'Inserisci punto elenco [*]';
s_video_help = 'Inserisci file video: [video width=# height=#]URL File[/video]';
s_googlevideo_help = 'Inserisci file Google Video: [googlevideo]Google Video ID[/googlevideo]';
s_youtube_help = 'Inserisci file video YouTube: [youtube]YouTube ID[/youtube]';
s_quick_help = 'Inserisci file Quicktime video: [quick]http://quicktime_video_url/[/quick]';
s_flash_help = 'Inserisci file flash: [flash width=# height=#]Flash URL[/flash]';
s_ram_help = 'Inserisci file Real Media : [ram]URL File[/ram]';
s_stream_help = 'Inserisci file audio: [stream]URL File[/stream]';
s_emff_help = 'Inserisci file mp3: [emff]URL File[/emff]';
s_fade_help = 'Sfumatura: [opacity]testo[/opacity] oppure [opacity][img]http://image_url/[/img][/opacity]';
s_spoiler_help = 'Spoiler: [spoiler]testo[/spoiler]';
s_cell_help = 'Cella: [cell]testo[/cell]';
s_list_help = 'Lista ordinata: [list|=1|a]testo[/list] (Consiglio: usa [*] per inserire nuovi elementi)';
s_listo_help = 'Lista ordinata: [list=1|a]testo[/list] (Consiglio: usa [*] per inserire nuovi elementi)';
s_help_help = 'BBCode FAQ';
s_image_upload_help = 'Carica un\'immagine su PostImage.org e l\'aggiunge al messaggio';
s_posticyimage_help = 'Carica un\'immagine e l\'aggiunge al messaggio';
s_smiley_creator = 'Smiley Creator: [smiley=1]Testo[/smiley] inserisce uno smiley con testo';
