...
*
* @package Icy Phoenix
* @version $Id: posting.php 110 2009-07-14 08:09:47Z Mighty Gorgon $
...
while(list($var, $param) = @each($params))
{
	...
	{
		// FIX 4/11/2013 $$var = (!empty($_POST[$param])) ? htmlspecialchars($_POST[$param]) : htmlspecialchars($_GET[$param]);
...
if($refresh || isset($_POST['del_poll_option']) || ($error_msg != ''))
{
	...
	*/
	...
	$topic_desc = (!empty($_POST['topic_desc'])) ? htmlspecialchars(trim(stripslashes($_POST['topic_desc'])), ENT_COMPAT, 'ISO-8859-1') : '';
	$notes = empty($_POST['notes']) ? '' : trim(stripslashes($_POST['notes']));
