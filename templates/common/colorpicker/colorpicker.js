...
Refresh.Web.ColorPicker.prototype = {
	...
	initialize: function(id, settings) {
		...
		this._mapBase.style.border = 'solid 1px #000000';
		...
		this._bar.style.border = 'solid 1px #000000';
		...
		// attach map slider
		this._map = new Refresh.Web.Slider(this._mapL2, 'cp_mappoint', {xMaxValue: 255, yMinValue: 255, arrowImage: this.settings.clientFilesPath + 'mappoint.gif'});

		// attach color slider
		this._slider = new Refresh.Web.Slider(this._barL4, 'cp_arrows', {xMinValue: 1,xMaxValue: 1, yMinValue: 255, arrowImage: this.settings.clientFilesPath + 'rangearrows.gif'});;
