...
function BBCLatex()
{
	...
	{
		//mozWrap(txtarea, "[b]", "[/b]");
		mozInsert(txtarea, "[tex]", "[/tex]");
		return;
	}
	if (LaTex == 0)
	{
		ToAdd = "[tex]";
		document.forms[form_name].latex_img.src = bbcb_mg_img_path + "latex1" + bbcb_mg_img_ext;
		LaTex = 1;
	}
	else
	{
		ToAdd = "[/tex]";
		document.forms[form_name].latex_img.src = bbcb_mg_img_path + "latex" + bbcb_mg_img_ext;
		LaTex = 0;
	}
	PostWrite(ToAdd);
}
