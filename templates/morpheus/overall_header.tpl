...
<tr>
	<td width="9" valign="bottom"><img src="{FULL_SITE_PATH}{LOGO_LEFT}" width="9" alt="" /></td>
	<td width="100%" class="logo"><table width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td align="left"><a href="{FULL_SITE_PATH}{U_PORTAL}"><img src="{FULL_SITE_PATH}{SITELOGO}" alt="{L_HOME}" /></a></td></tr></table></td>
	<td width="9" valign="bottom"><img src="{FULL_SITE_PATH}{LOGO_RIGHT}" width="9" alt="" /></td>
</tr>
<tr>
	...
	<td class="buttons1" align="center" valign="top">
		...
		<tr>
			...
			<td class="buttons" nowrap="nowrap">
				...
				<a href="http://wiki.informateci.org">Wiki</a>&nbsp;&nbsp;<img src="{FULL_SITE_PATH}{IMG_MENU_SEP}" alt="" />&nbsp;
